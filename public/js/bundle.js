      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Welcome Back");
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          res = _context2.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Good Bye");
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, email, password, confirmPassword) {
    var res;
...
var Favourite = exports.Favourite = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(tourId, type) {
    var url, result;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          _context5.prev = 0;
          url = type === 'add' ? "/api/v1/tours/addtofav/".concat(tourId) : "/api/v1/tours/removefromfav/".concat(tourId);
          _context5.next = 4;
          return (0, _axios.default)({
            method: 'POST',
            url: url
        ...
        case 4:
          ...
          if (result.data.status === "success") {
            (0, _alert.showAlert)("success", "Favourite Tour ".concat(type, " Successfully "));
          }
          _context5.next = 11;
          break;
        case 8:
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " Updated Succefully"));
            window.setTimeout(function () {
              location.assign('/me');
            }, 1500);
          }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = Stripe('pk_test_51PmxFB03M2HpK3naRt4pJl6TfMQbifflc963Q6J3u6cac4yoncwovfkogp9HoTX08NRurcHhTxm8CrlxOBjK3acg00Rnu2L9ya');
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          if (_context.t0.response) {
            contentType = _context.t0.response.headers['content-type']; // If response is HTML, render the HTML error page
            if (contentType.includes('text/html')) {
              document.open();
              document.write(_context.t0.response.data);
              document.close();
            } else {
...
var updateUserDataform = document.querySelector('.form--update-user-data');
var updateUserPassform = document.querySelector('.form--update-user-password');
...
if (loginForm || signUpForm) {
  if (loginForm) {
    ...
    signUpForm.addEventListener('submit', function (e) {
      ...
      (0, _collection.signup)(name, email, password, confirmpassword);
    });
  }
}
if (logoutBtn) logoutBtn.addEventListener('click', _collection.logout);
...
if (updateUserPassform) {
  updateUserPassform.addEventListener('submit', /*#__PURE__*/function () {
...
if (favBtn) {
  var tourId = favBtn.dataset.tourId;
  document.addEventListener('DOMContentLoaded', function () {
    fetch("/api/v1/tours/".concat(tourId, "/favorite-status")).then(function (response) {
      return response.json();
    }).then(function (data) {
      data.isFavorited === true ? favBtn.classList.add('active') : favBtn.classList.remove('active');
    });
  });
  favBtn.addEventListener('click', /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 3;
            return (0, _collection.Favourite)(tourId, 'remove');
          case 3:
          ...
          case 7:
            _context3.next = 9;
            return (0, _collection.Favourite)(tourId, 'add');
          case 9:
